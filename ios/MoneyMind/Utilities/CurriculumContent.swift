...
nonisolated enum CurriculumContent: Sendable {
    static let sessions: [CurriculumSessionContent] = [
        ...
        CurriculumSessionContent(
            ...
            reflectionPrompt: "Which 3 tools from your MoneyMind toolkit feel most natural to you? Why?"
        ),
        CurriculumSessionContent(
            number: 4,
